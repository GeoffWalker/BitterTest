	...
	//	  Keep that in mind for future exercises.
	   ...
	   echo '
		...
		if ($rowProd["Option1Desc"] != "") {
			echo '<br clear=all /><br /> '. $rowProd["Option1Desc"] . ' <br /><ul>'; //end echo
                            if($rowProd["Option1a"] != "") echo '<li>'. $rowProd["Option1a"] .'</li>';
                            if($rowProd["Option1b"] != "") echo '<li>'. $rowProd["Option1b"] .'</li>';
                            if($rowProd["Option1c"] != "") echo '<li>'. $rowProd["Option1c"] .'</li>';
                            if($rowProd["Option1d"] != "") echo '<li>'. $rowProd["Option1d"] .'</li>';
                        echo '</ul>';	
		}
		...
		if ($rowProd["Option2Desc"] != "") {
			echo '<br clear=all /><br /> '. $rowProd["Option2Desc"] . ' <br /><ul>'; //end echo
                            if($rowProd["Option2a"] != "") echo '<li>'. $rowProd["Option2a"] .'</li>';
                            if($rowProd["Option2b"] != "") echo '<li>'. $rowProd["Option2b"] .'</li>';
                            if($rowProd["Option2c"] != "") echo '<li>'. $rowProd["Option2c"] .'</li>';
                            if($rowProd["Option2d"] != "") echo '<li>'. $rowProd["Option2d"] .'</li>';
                        echo '</ul>';	
		}	
} // End of the while		
