    ...
    <div class="container">
		<div class="row">
			...
			<div class="main-login main-center">
				<h4>Contact Us: for all your trolling needs!</h4>
                                <h6>Phone Number: (506) 453-0710</h6>
                                <h6>Fax Number: it's 2018</h6>
                                <h6>Address: 123 Main St.</h6>
                                <h6><a href="mailto:geoff-walker@hotmail.com?subject=Email">Email Us</a></h6>
			</div>
